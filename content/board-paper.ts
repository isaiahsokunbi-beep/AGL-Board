...
export const cover: CoverData = {
  ...
  metrics: [
    ...
    },
    {
      ...
      negative: true,
      tone: "loss",
      subtitle: "after finance and logistics costs",
    },
  ],
};
      ...
      },
      {
        ...
        highlights: [
          ...
          },
          {
            ...
            label: "Largest gap",
            detail:
              "Export sales −93.4% vs budget pending NEXIM and ship availability",
          },
          {
            type: "loss",
            label: "Bottom line",
            detail: "Net loss of ₦73.6M after finance and logistics costs",
          },
        ],
        paragraphs: [
          "H1 2026 delivered revenue broadly in line with a challenging budget, but full-year profitability was materially below plan once the complete cost base is reflected. Revenue reached ₦1,123.6M, 51.5% of the confirmed ₦2,180.9M H1 budget, on volume of 840.4 MT across 41 trades, with gross margin of 18.1%. After finance and logistics costs, the net loss was ₦73.6M.",
          ...
          "Export sales were the largest single driver of the shortfall, at 93.4% below budget pending NEXIM and ship availability; this emerged due to trade disruptions due to war. Local Trades also under-shot at 47.5% below budget. Projects was the one bright spot, closing H1 at 49.1% ahead of budget.",
        ],
      },
    ],
  },
    ...
    subsections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The pace and scale of expansion will significantly enable the business to increase outreach, deepen financial inclusion, and deliver greater impact across rural communities. https://docs.google.com/spreadsheets/d/1hi2It4kdo0yYEqgsMcri_v0ngIcv08BHNFr7sYEd-tU/edit?usp=sharing",
        ],
      },
      {
        id: "logistics",
        ...
        paragraphs: [
          ...
          "This model will need a specialist to define the opportunities, impact on business and mgt processes. It is currently added to our ESP pillars. Planning spreadsheet: https://docs.google.com/spreadsheets/d/1dLnudSNKXohStFJR3HBOGI2lI2BxTd_tpR2NqyTqeRA/edit?usp=sharing",
        ],
      },
      {
        id: "sahel-repayment",
